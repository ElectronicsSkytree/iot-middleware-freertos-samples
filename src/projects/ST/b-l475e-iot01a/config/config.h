 ...
 */
    ...
    #define WIFI_SSID                            "Skytree" // office
#elif defined(KOPPERT_CRESS_SETUP)
    #define WIFI_SSID                            "SkytreeIoT2" // 4G router Koppert Cress
#elif defined(FIELDLESS_SETUP)
 ...
 */
    ...
    #define WIFI_PASSWORD                        "5kytr335t4ff" // office
#elif defined(KOPPERT_CRESS_SETUP)
    #define WIFI_PASSWORD                        "2kytree12345" // 4G router Koppert Cress
#elif defined(FIELDLESS_SETUP)
...
#define configCHUNK_DOWNLOAD_SIZE        2048

#define configSNTP_INIT_WAIT             1000000000U
